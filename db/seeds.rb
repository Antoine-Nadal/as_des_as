...
bar_a_jeu_2 = GamingSession.new(name: "les mauvais joueurs", address: "46 Rue Sedaine, 75011 Paris", number_of_participants: 30, user_id: 1, description: "grosses mises gros gains gros respect", price:500, food:drink_food_boolean.sample, drink:drink_food_boolean.sample, game_type: GamingSession::GAMES_TYPES.shuffle.sample)
...
bar_a_jeu_3 = GamingSession.new(name: "la revanche", address: "38 Av. Daumesnil, 75012 Paris", number_of_participants: 20, description:"tournois hebdomadaires, de nombreux lots à gagner! entrée gratuite", price:350, food:drink_food_boolean.sample, drink:drink_food_boolean.sample, game_type: GamingSession::GAMES_TYPES.shuffle.sample)
...
bar_a_jeu_4 = GamingSession.new(name: "Oya", address: "25 Rue de la Reine Blanche, 75013 Paris", number_of_participants: 35, description:"ouvert 24h/24h, venez vous enjailler chez Oya! places de parking dédiées", price:600)
