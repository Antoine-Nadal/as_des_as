...
bar_a_jeu_1 = GamingSession.new(name: "le cocon ludique", address: "227 Rue Saint-Martin, 75003 Paris", number_of_participants: 50, description: "blablabla", price:800)
...
bar_a_jeu_2 = GamingSession.new(name: "les mauvais joueurs", address: "46 Rue Sedaine, 75011 Paris", number_of_participants: 30, user_id: 1, description: "blablabla", price:500)
...
bar_a_jeu_3 = GamingSession.new(name: "la revanche", address: "38 Av. Daumesnil, 75012 Paris", number_of_participants: 20, description:"blablabla", price:350)
...
bar_a_jeu_5 = GamingSession.new(name: "Dernier bar avant la fin du monde", address: "19 Av. Victoria, 75001 Paris", number_of_participants: 50, description:"blablabla", price:850)
bar_a_jeu_5.user = user_1
bar_a_jeu_4.photos.attach(io: file13, filename: "bar51.jpg", content_type: "image/jpg")
bar_a_jeu_4.photos.attach(io: file14, filename: "bar52.jpg", content_type: "image/jpg")
bar_a_jeu_4.photos.attach(io: file15, filename: "bar53.jpg", content_type: "image/jpg")
bar_a_jeu_1.save
...
bar_a_jeu_6 = GamingSession.new(name: "Loufoque", address: "57 Rue Galande, 75005 Paris", number_of_participants: 35, description:"blablabla", price:700)
bar_a_jeu_6.user = user_4
bar_a_jeu_4.photos.attach(io: file16, filename: "bar61.jpg", content_type: "image/jpg")
bar_a_jeu_4.photos.attach(io: file17, filename: "bar62.jpg", content_type: "image/jpg")
bar_a_jeu_4.photos.attach(io: file18, filename: "bar63.jpg", content_type: "image/jpg")
bar_a_jeu_6.save
